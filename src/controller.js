export class Controller {
  constructor(LibraryModel, GameView, LibraryView) {
    ...
    this.gamePage.addEventListener('click', (e) =>
      this.handleGamePageEvents(e)
    );
    this.GameView.modal.addEventListener('click', (e) =>
      this.handleModalEvents(e)
    );
  }
  // HANDLERS
  // LIBRARY HANDLERS
  ...
  handleAddLibrary(value) {
    ...
    if (form.checkValidity()) {
      if (this.LibraryView.renameInput) {
        ...
        this.Model.saveData();
        this.GameView.updateGameView(
          this.Model.activeLibrary.array,
          this.Model.activeLibrary.name
        );
  ...
  handleAddLibInput = () => {
    if (this.LibraryView.renameInput)
      return document.querySelector('#lib-input').focus();
  ...
  handleExpandGame = (gameCont) => {
    if (this.GameView.expandState) {
      ...
      if (
        this.Model.activeLibrary.array.indexOf(this.Model.activeGame) ===
        this.GameView.clickedGame(gameCont)
      ) {
  ...
  switchGame = (gameCont) =>
    (this.Model.activeGame = this.GameView.clickedGame(gameCont));
